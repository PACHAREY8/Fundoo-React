...
//         expect(shallow( < RegisterComponent / > ).find('#firstName').length).toEqual(1)
//     })
//     it('renders a lastName input', () => {
//         expect(shallow( < RegisterComponent / > ).find('#lastName').length).toEqual(1)
//     })
//     it('renders a userName input', () => {
//         expect(shallow( < RegisterComponent / > ).find('#userName').length).toEqual(1)
//     })
//     it('renders a password input', () => {
//         expect(shallow( < RegisterComponent / > ).find('#password').length).toEqual(1)
//     })
//     it('renders a confirm password input', () => {
//             expect(shallow( < RegisterComponent / > ).find('#confirm_password').length).toEqual(1)
//         })
//         /**
//          * within the RegisterComponent components describe function
//          **/
